...
int main(void)
{
	...
	for (c = 2; c < 98; c++)
	{
		...
		{ 
			...
			ii = (a1 + b1);
			i = a + b + (ii / 1000000000); /*for any number VVVV*/
			printf(", %ld", i); /* goes over that needs to be added*/
			printf("%ld", ii % 1000000000); /*the '%' here soVVVV*/
			a = b; /* we only take the first 9 numbers only*/
			a1 = b1;
			b = i;
			b1 = (ii % 1000000000);
		}
